...
console.log(sketch)
document.getElementById("predefined_sketch").innerHTML = "Sketch to be drawn: " + sketch
...
function classifyCanvas(){
    classifier.classify(canvas, foundResult)
}
function foundResult(error, result){
    if(error){
        ...
        document.getElementById("user_sketch").innerHTML=drawn_sketch
